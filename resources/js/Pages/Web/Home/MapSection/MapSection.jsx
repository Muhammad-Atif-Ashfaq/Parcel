...
import MapComponent from "@/Pages/Web/Home/MapSection/MapComponent/MapComponent";
...
export default function MapSection({CollectionPoints, mapSectionRef}) {
    ...
    return (
        <>
            <div ref={mapSectionRef} style={{background: web.bgGray}}>
                <Container sx={mapSection.container}>
                    <Typography variant="h4" fontWeight="bold" gutterBottom sx={mapSection.h4}>
                        Puncte de colectare
                    </Typography>
                    <Typography variant="subtitle1" gutterBottom>
                        Aici sunt toate punctele de colectare din Marea Britanie și Moldova
                    </Typography>
                    <Box sx={{
                        width: '100%',
                                            ...
                                            >
                                                <Card sx={{
                                                    ...
                                                    <CardContent sx={{padding: '5px 0px 0px 10px'}}>
                                                        ...
                                                        <TruncateText text={place.last_collection_date} limit={15}/>
