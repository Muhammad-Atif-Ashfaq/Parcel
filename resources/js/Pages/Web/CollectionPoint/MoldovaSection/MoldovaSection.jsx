...
import MapComponent from "@/Pages/Web/CollectionPoint/MoldovaSection/MapComponent/MapComponent";
        ...
        <>
            <div style={{background: web.bgGray}}>
                <Container sx={mapSection.container}>
                    ...
                    {/*    Here are all collection points of  Moldova*/}
                    {/*</Typography>*/}
                    <Box sx={{
                        width: '100%',
