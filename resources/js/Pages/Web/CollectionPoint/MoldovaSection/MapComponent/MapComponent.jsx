...
export default function MapComponent({ points, selectedPoint, userLocation }) {
  ...
  const center = userLocation ? userLocation : selectedPoint ? { lat: parseFloat(selectedPoint.latitude), lng: parseFloat(selectedPoint.longitude) } : { lat: 47.619990401716926, lng: 28.419789235412654 };
  const zoom = userLocation ? 15 : selectedPoint ? 15 : 7;
